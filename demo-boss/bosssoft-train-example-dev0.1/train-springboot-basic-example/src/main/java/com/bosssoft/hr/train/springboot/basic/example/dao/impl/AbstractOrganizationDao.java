...
import com.bosssoft.hr.train.springboot.basic.example.dao.mapper.OrganizationMapper;
import com.bosssoft.hr.train.springboot.basic.example.pojo.entity.Organization;
import com.bosssoft.hr.train.springboot.basic.example.pojo.query.OrganizationQuery;
 ...
 * @since 1.0
 **/
public abstract class AbstractOrganizationDao<T,M extends CommonMapper<T>>   extends AbstractBaseDao <Organization, OrganizationMapper,OrganizationQuery>  implements OrganizationDao<Organization, OrganizationQuery> {
