  ...
  <div class="app-container">
    ...
    <div class="paperForm">
      ...
      >
        ...
        <el-table-column align="center" prop="discribe" label="模板描述" width="150"></el-table-column>
    ...
    <!-- 弹窗 -->
    <!-- 预览 -->
    <el-dialog title="预览模板" :visible.sync="previewTag" width="28%">
    ...
    <!-- 详情 -->
    <el-dialog title="题目" :visible.sync="details" width="700px" >
      <el-form :model="subjectform" :inline="true" :rules="subjectRules" ref="subjectform" class="subjectform">
        <el-form-item label="模板名称"  prop="paperName">
          <el-input v-model="subjectform.paperName" style="width:180px"></el-input>
        </el-form-item>
        <el-form-item label="模板类型"  prop="paperType" style="margin-left:20px">
          <el-select v-model="subjectform.paperType" placeholder="请选择类型" style="width:180px">
            <el-option label="算法卷" value="1"></el-option>
            <el-option label="基础卷" value="2"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="模板难度"  prop="difficulty">
          ...
          <el-form-item label="所属公司" prop='companyName' style="margin-left:20px">
          <el-select v-model="subjectform.companyName" placeholder="请选择公司" style="width:180px">
            <el-option label="ZYZ.公司02" value="3"></el-option>
            <el-option label="ZYZ.公司07" value="1280752080759427072"></el-option>
            <el-option label="ZYZ.公司06" value="1280761756272168960"></el-option>
            <el-option label="ZYZ.公司05" value="1280768023539617792"></el-option>
            <el-option label="ZYZ.公司04" value="1280768086689058816"></el-option>
            <el-option label="ZYZ.公司03" value="1280831192899391488"></el-option>
            <el-option label="XMJ.公司01" value="1281078274612662272"></el-option>
            <el-option label="ZYZ.公司01" value="1284858894321061888"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="组卷时间"  prop="combExamTime" style="margin-left:10px">
          <el-input
        ...
        <el-form-item label="模板分数"  prop="score" style="margin-left:30px">
          <el-input v-model="subjectform.score" autocomplete="off" style="width:180px" readonly></el-input>
        </el-form-item>

        <el-form-item label=" 修  改  人 " prop="updatedMan" style="margin-right:30px">
          <el-input v-model="subjectform.updatedMan" autocomplete="off" style="width:180px" readonly></el-input>
        </el-form-item>

          <el-form-item label="是否启用" style="margin-left:5px" prop='status'>
            <template>
              <el-radio v-model="subjectform.status" label="1" style="margin-left:6px">启用</el-radio>
              <el-radio v-model="subjectform.status" label="0">禁用</el-radio>
            </template>
          </el-form-item>
           <el-form-item label="模板描述"  style="margin-left:8px">
          <el-input v-model="subjectform.discribe" autocomplete="off" style="width:470px"></el-input>
        </el-form-item>
      </el-form>

      <el-table :data="subjectData" style="margin-top:20px">
        <el-table-column property="id" v-if="show"></el-table-column>
        <el-table-column property="subject" label="题目" align="center" width="200"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    paperDetails(row) {
      ...
      axios
        ...
        .then(resp => {
          ...
          this.subjectform.companyId = String(resp.data.body.companyId);
          this.subjectform.status = String(resp.data.body.status);
    ...
    //单行删除
    deletePaper(row) {
      this.$confirm("确定删除模板" + row.paperName + "吗？", "消息", {
    ...
    updatePaper(subjectform) {
      this.$refs[subjectform].validate(valid => {
        if (valid) {
          //修改试卷信息
          axios
            .post("/education/bes/v1/boss-bes-paper-center/paper/updatePaper/", {
                ...
                updatedBy:this.subjectform.updatedBy,
                companyId:this.subjectform.companyId
            })
            .then(resp => {
              if(resp.data.body =="数据正在被使用"){
