...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-2 col-sm-2">
				<input class="btn btn-primary radius" type="button" id="search" value="&nbsp;&nbsp;搜索&nbsp;&nbsp;">
			</div>
		</div>
		<div class="row cl">
